                ...
                <div className="container px-4 mx-auto">
                    <div className="max-w-lg mx-auto">
                        <div className="text-center mb-8">
                            ...
                            <h2 className="text-3xl md:text-4xl font-extrabold mb-2">Login your account</h2>
                        </div>
                        <form onSubmit={hendelSubmit} action="">
                            ...
                            <p className="text-center font-extrabold">Don&rsquo;t have an account? <Link to='/register' className="text-red-500 hover:underline" >Register page</Link></p>
                        </form>
                    </div>
                </div>
            </div>
